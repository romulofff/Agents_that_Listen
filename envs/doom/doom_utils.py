...
DOOM_ENVS = [
    ...
    DoomSpec(
        "doom_eval_hg_30med_audio_no_poison",
        "eval_hg_30med_audio_no_poison.cfg",  # use your custom cfg here
        Discrete(1+4),
        reward_scaling=1.0,
        default_timeout=2100,
        extra_wrappers=[(DoomGatheringRewardShaping, {}), SOUND_INPUT]
    ...
    DoomSpec(
        ...
        "health_gathering_sound_splitted.cfg",  # use your custom cfg here
        Discrete(1+4),
        reward_scaling=1.0,
        default_timeout=2100,
        extra_wrappers=[(DoomGatheringRewardShaping, {}), SOUND_INPUT]
    ...
    DoomSpec(
        "doom_health_gathering_sound_medikit_only_splitted",
        "health_gathering_sound_medikit_only_splitted.cfg",  # use your custom cfg here
        Discrete(1+4),
        reward_scaling=1.0,
        default_timeout=2100,
        extra_wrappers=[(DoomGatheringRewardShaping, {}), SOUND_INPUT]
